...
class CreateOtpViewModel @Inject constructor(context: Context, val resourceProvider: ResourceProvider) :
    ...
    private val mResponse: MutableLiveData<String> = MutableLiveData<String>()
